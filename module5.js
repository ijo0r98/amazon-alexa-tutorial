//Module5. Help Your Skill Remember with persistent attributes

// This sample demonstrates handling intents from an Alexa skill using the Alexa Skills Kit SDK (v2).
// Please visit https://alexa.design/cookbook for additional examples on implementing slots, dialog management,
// session persistence, api calls, and more.
const Alexa = require('ask-sdk-core');
const persistenceAdapter = require('ask-sdk-s3-persistence-adapter'); //save the value to AmazonS3, module exports
...
const HasBirthdayLaunchRequestHandler = {
    canHandle(handlerInput) {
        //checks if the user's birthday info is saved in AmazonS3
        ...
        //if it is, the handler lets the sdk know it can do the work
        return handlerInput.requestEnvelope.request.type === 'LaunchRequest' &&
            year &&
            month &&
            day;
...
const CaptureBirthdayIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        //await: puase and continue after the user's info is saved to amazons3
...
//communicate with AmazonS3 ->to consolidate, use an interceptors
...
exports.handler = Alexa.SkillBuilders.custom()
    ...
    .addRequestInterceptors( //register the interceptor to let the sdk know it exists
